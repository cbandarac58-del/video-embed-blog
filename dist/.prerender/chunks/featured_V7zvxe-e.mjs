...
//#region src/pages/featured.astro
var featured_exports = /* @__PURE__ */ __exportAll({
	default: () => $$Featured,
	file: () => $$file,
	url: () => $$url
});
var $$Featured = createComponent(async ($$result, $$props, $$slots) => {
	const PER_PAGE = 40;
	let videos = [];
	try {
...
var $$file = "C:/Users/Pubudu Nuwan/.gemini/antigravity/scratch/video-embed-blog/src/pages/featured.astro";
var $$url = "/featured";
//#endregion
//#region \0virtual:astro:page:src/pages/featured@_@astro
var page = () => featured_exports;
//#endregion
export { page };
