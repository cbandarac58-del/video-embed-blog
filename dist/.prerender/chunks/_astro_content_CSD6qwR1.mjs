import { Ct as removeBase, E as AstroError, S as unescapeHTML, T as createComponent, bt as isRemotePath, et as UnknownContentCollectionError, f as renderTemplate, h as generateCspDigest, t as spreadAttributes } from "./server_DdnRNRi_.mjs";
...
var ImmutableDataStore = class ImmutableDataStore {
	...
	*/
	static async fromModule() {
		try {
			const data = await import("./_astro_data-layer-content_BQzeIlYm.mjs");
...
var _astro_content_exports = /* @__PURE__ */ __exportAll({
...
//#endregion
export { getCollection as n, __exportAll as r, _astro_content_exports as t };
