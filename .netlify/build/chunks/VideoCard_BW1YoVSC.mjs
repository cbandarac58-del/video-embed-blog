...
const $$VideoCard = createComponent(($$result, $$props, $$slots) => {
  ...
  const data = video.data || video;
  const { title, slug, rating = 90, views, category, tags = [], thumbnailUrl, dateAdded } = data;
